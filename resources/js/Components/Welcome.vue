...
<template>
    <div>
        ...
        >
            ...
            <h1
                class="mt-8 text-2xl font-medium text-slate-900 dark:text-white"
            >
        ...
        <div
            class="bg-slate-200 dark:bg-slate-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8"
        >
            <div>
                <div class="flex items-center">
                    ...
                    <h2
                        class="ml-3 text-xl font-semibold text-slate-900 dark:text-white"
                    >
